...
<p><a href="{{ url('/reset?email='.$email) }}" style="display: inline-block; background-color: #7A96A9; color: #fff; padding: 8px; border-radius: 4px; text-decoration: none;">Resetear mi contraseña</a></p>
