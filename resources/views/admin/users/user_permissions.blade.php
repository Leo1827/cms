...
<li class="breadcrumb-item ">
	<a href="{{ url('/admin/users/all') }}"  style="text-decoration: none;"><i class="fas fa-user-friends"></i> Usuarios</a>
</li>
<li class="breadcrumb-item ">
	<a href="{{ url('/admin/users/all') }}"  style="text-decoration: none;"><i class="fas fa-cogs"></i> Usuario permisos: {{$u->name}} {{$u->lastname}} (ID:{{$u->id}})</a>
</li>
@endsection
