...
<li class="breadcrumb-item ">
	<a href="{{ url('/admin/products/1') }}"  style="text-decoration: none;"><i class="fas fa-boxes"></i> Producto</a>
</li>
@endsection
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						<td width="50">{{ $p->id }}</td>
						<td width="64">
							<a href="{{ url('/upload/'.$p->file_path.'/'.$p->image)}}" data-fancybox="gallery">
							    <img src="{{ url('/upload/'.$p->file_path.'/t_'.$p->image)}}" width="64px">
							</a>
						</td>
