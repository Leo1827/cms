...
<li class="breadcrumb-item ">
	<a href="{{ url('/admin/products/all') }}"  style="text-decoration: none;"><i class="fas fa-boxes"></i> Productos</a>
</li>
<li class="breadcrumb-item ">
	<a href="{{ url('/admin/product/add') }}"  style="text-decoration: none;"><i class="fas fa-plus"></i> Agregar producto</a>
</li>
@endsection
